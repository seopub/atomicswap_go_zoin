...
var MainNetParams = Params{
	...
	DNSSeeds: []DNSSeed{
		{"sf1.zcoin.io", false},
		{"sf2.zcoin.io", false},
		{"london.zcoin.io", false},
		{"singapore.zcoin.io", false},
		{"nyc.zcoin.io", false},
	},
	...
	PubKeyHashAddrID:        0x50, // gf: starts with Z
...
var TestNet3Params = Params{
	...
	DefaultPort: "18168",
	DNSSeeds: []DNSSeed{
		{"beta1.zcoin.io", false},
		{"beta2.zcoin.io", false},
	},
	...
	// Address encoding magics
	PubKeyHashAddrID:        0x41, // gf: starts with T
	ScriptHashAddrID:        0xb2, // gf: starts with ?
	WitnessPubKeyHashAddrID: 0xb9, // gf: starts with ?
