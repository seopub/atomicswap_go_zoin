...
func (view *UtxoViewpoint) AddTxOuts(tx *xzcutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *xzcutil.Tx, blockHeight int32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *xzcutil.Block, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *xzcutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *xzcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *xzcutil.Tx) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
