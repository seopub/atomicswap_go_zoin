...
// txouts.
func dbFetchSpendJournalEntry(dbTx database.Tx, block *xzcutil.Block, view *UtxoViewpoint) ([]spentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := xzcutil.NewBlock(b.chainParams.GenesisBlock)
...
func (b *BlockChain) initChainState() error {
	...
	err := b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(xzcutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a xzcutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*xzcutil.Block, error) {
...
func (b *BlockChain) BlockByHeight(blockHeight int32) (*xzcutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*xzcutil.Block, error) {
