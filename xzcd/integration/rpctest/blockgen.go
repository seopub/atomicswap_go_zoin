...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr xzcutil.Address, net *chaincfg.Params) (*xzcutil.Tx, error) {
...
func CreateBlock(prevBlock *xzcutil.Block, inclusionTxs []*xzcutil.Tx,
	blockVersion int32, blockTime time.Time,
	miningAddr xzcutil.Address, net *chaincfg.Params) (*xzcutil.Block, error) {
	...
	blockTxns := []*xzcutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := xzcutil.NewBlock(&block)
