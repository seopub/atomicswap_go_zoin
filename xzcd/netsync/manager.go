...
// processed.
func (sm *SyncManager) QueueTx(tx *xzcutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *xzcutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *xzcutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
