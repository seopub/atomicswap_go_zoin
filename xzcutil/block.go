...
// Tx returns a wrapped transaction (xzcutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (xzcutil.Tx) for all
...
// instead provides easy access to wrapped versions (xzcutil.Tx) of them.
