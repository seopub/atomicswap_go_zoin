...
var (
        ...
        connectFlag = flagset.String("s", "127.0.0.1:8256", "host[:port] of Zcoin Core wallet RPC server")
        rpcuserFlag = flagset.String("rpcuser", "rpc", "username for wallet RPC authentication")
        rpcpassFlag = flagset.String("rpcpass", "rpc", "password for wallet RPC authentication")
...
//      params2 := []json.RawMessage{param0, param1}
        params2 := []json.RawMessage{param0}
