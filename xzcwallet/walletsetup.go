...
import (
	...
	"seopub/xzcwallet/internal/legacy/keystore"
	"seopub/xzcwallet/internal/prompt"
	"seopub/xzcwallet/waddrmgr"
	"seopub/xzcwallet/wallet"
	"seopub/xzcwallet/walletdb"
	_ "seopub/xzcwallet/walletdb/bdb"
)
...
func convertLegacyKeystore(legacyKeyStore *keystore.Store, manager *waddrmgr.Manager) error {
	...
	for _, walletAddr := range legacyKeyStore.ActiveAddresses() {
		...
		case keystore.PubKeyAddress:
			...
			wif, err := xzcutil.NewWIF((*btcec.PrivateKey)(privKey),
